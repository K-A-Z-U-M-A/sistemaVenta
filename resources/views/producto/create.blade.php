                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="tipo_producto" id="tipo_producto" class="form-control selectpicker show-tick">
                            ...
                            <option value="trago" {{ old('tipo_producto') == 'trago' ? 'selected' : '' }}>Trago</option>
                        </select>
                        @error('tipo_producto')
                        <small class="text-danger">{{'*'.$message}}</small>
                        @enderror
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="precio_venta" id="precio_venta" class="form-control" step="0.01" min="0" value="{{old('precio_venta', 0)}}">
                        @error('precio_venta')
                        <small class="text-danger">{{'*'.$message}}</small>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="impuesto" id="impuesto" class="form-control selectpicker show-tick">
                            <option value="10" {{ old('impuesto') == '10' ? 'selected' : '' }}>IVA 10%</option>
                            <option value="5" {{ old('impuesto') == '5' ? 'selected' : '' }}>IVA 5%</option>
                            <option value="0" {{ old('impuesto') == '0' ? 'selected' : '' }}>Exento (0%)</option>
                        </select>
                        @error('impuesto')
                        <small class="text-danger">{{'*'.$message}}</small>
                        @enderror
                    ...
                    <div class="col-md-6" id="div_descuento_trago" style="display: none;">
                        <div class="form-check mt-4">
                            <input class="form-check-input" type="checkbox" name="aplica_descuento_trago" id="aplica_descuento_trago" value="1" {{ old('aplica_descuento_trago') ? 'checked' : '' }}>
