<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    ...
    <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
        <li class="nav-item me-2">
            <button class="btn btn-outline-light" data-bs-toggle="modal" data-bs-target="#qrModal" onclick="generateQR()">
                <i class="fas fa-qrcode"></i> <span class="d-none d-md-inline">Conectar Móvil</span>
            </button>
        </li>
        <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                ...
                <li><a class="dropdown-item" href="{{ route('activity-log.index') }}">Registro de actividad</a></li>
                @endhasrole
                <li>
